<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center">
            <a href="{{route('items.show', $item)}}" class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 mx-2 rounded-full">Go back</a>
                ...
                <div class="p-6 text-gray-900">
                    <form action="{{route('items.update', $item)}}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <select name="category" class="py-3 px-4 block w-full border-gray-200 rounded-md text-sm focus:border-blue-500 focus:ring-blue-500">
